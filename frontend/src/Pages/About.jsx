    ...
    <div className="bg-white">
      ...
      <section className="py-5 bg-success text-white text-center">
        <div className="container">
          ...
          <p className="lead">Serving our neighbors in Michoacán with pride since [Year].</p>
        </div>
      </section>
        ...
        <div className="container py-5">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 ps-lg-5">
              ...
              <p className="text-secondary">
                Our mission is simple: to provide precision lawn care that blends traditional hard work with modern technology. By using a data-driven approach to fertilization and a client-first portal, we make lawn maintenance completely stress-free.
              </p>
            </div>
          </div>
        </div>
